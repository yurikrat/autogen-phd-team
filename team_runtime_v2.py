#!/usr/bin/env python3
"""
Team Runtime V2: Versão simplificada com menos agentes para teste.
"""
...
async def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("   Uso: python team_runtime_v2.py \"Sua tarefa aqui...\"")
        sys.exit(1)
...
- Finalizer: liste artefatos, gere MANIFEST e encerre com "CONCLUÍDO"
